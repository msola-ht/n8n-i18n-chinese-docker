...
docker run -d \
  ...
  lunare/n8n-chinese:1.122.5latest
...
docker run -d \
  ...
  -e N8N_DEFAULT_LOCALE=zh-CN \
  -e GENERIC_TIMEZONE=Asia/Shanghai \
  lunare/n8n-chinese-enterprise:1.122.5latest
```
...
- **版本**: `1.120.4` / `latest`
- **标签**: `docker pull lunare/n8n-chinese:1.122.5`

### 企业版
- **镜像**: `lunare/n8n-chinese-enterprise`
- **版本**: `1.120.4` / `latest`
- **标签**: `docker pull lunare/n8n-chinese-enterprise:1.122.5`
...
services:
  n8n:
    image: lunare/n8n-chinese-enterprise:1.122.5latest  # 改为企业版镜像
```
