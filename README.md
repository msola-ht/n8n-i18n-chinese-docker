...
docker run -d \
  ...
  -e N8N_DEFAULT_LOCALE=zh-CN \
  -e GENERIC_TIMEZONE=Asia/Shanghai \
  lunare/n8n-chinese-enterprise:2.1.3
```
...
.123.6` / `latest`
- **标签**: `docker pull lunare/n8n-chinese:2.1.3`

### 企业版
- **镜像**: `lunare/n8n-chinese-enterprise`
.123.6` / `latest`
- **标签**: `docker pull lunare/n8n-chinese-enterprise:2.1.3`
...
services:
  n8n:
    image: lunare/n8n-chinese-enterprise:2.1.3  # 改为企业版镜像
```
