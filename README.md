...
|------|------|------------|----------|
| 社区版（官方源） | `latest` 或 `2.10.4` | [lunare/n8n-chinese](https://hub.docker.com/r/lunare/n8n-chinese) | 国际用户 |
| 社区版（国内源）🇨🇳 | `latest` 或 `2.10.4` | [lunare/n8n-chinese-cn](https://hub.docker.com/r/lunare/n8n-chinese-cn) | 国内用户（推荐） |
| 企业版 | `latest` 或 `2.10.4` | [lunare/n8n-chinese-enterprise](https://hub.docker.com/r/lunare/n8n-chinese-enterprise) | 学习测试 |
...
- 社区版：`n8n-chinese-2.10.4.tar.gz`
- 企业版：`n8n-chinese-enterprise-2.10.4.tar.gz`

国内源版本的镜像可在 [GitHub Actions Artifacts](https://github.com/msola-ht/n8n-i18n-chinese-docker/actions) 中下载。

导入镜像：
```bash
docker load -i n8n-chinese-2.10.4.tar.gz
```
